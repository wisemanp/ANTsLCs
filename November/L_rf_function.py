...
from November.plotting_preferences import band_colour_dict, band_marker_dict, band_offset_dict, band_ZP_dict, band_obs_centwl_dict, band_offset_label_dict, ANT_redshift_dict, ANT_luminosity_dist_cm_dict
