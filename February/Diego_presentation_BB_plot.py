...
for idx in [0]:
    ...
    if BB_curvefit == True:
        ...
        ax2.errorbar(BB_2dp['MJD'], BB_2dp['cf_R_cm'], yerr = BB_2dp['cf_R_err_cm'], linestyle = 'None', c = 'k', mfc = 'blue',
                    fmt = 'o', mec = 'k', mew = 0.5)
        ...
        ax4.errorbar(BB_fit_results['MJD'], BB_fit_results['cf_T_K'], yerr = BB_fit_results['cf_T_err_K'], linestyle = 'None', c = 'k', 
                    fmt = 'o', zorder = 1, label = r'$\chi_{\nu}$'+f'>{colour_cutoff}')
        ax4.errorbar(BB_2dp['MJD'], BB_2dp['cf_T_K'], yerr = BB_2dp['cf_T_err_K'], linestyle = 'None', c = 'k', mfc = 'blue',
                    fmt = 'o', mec = 'k', mew = 0.5)
    ...
    fig.supxlabel('MJD', fontsize = (titlefontsize - 5), fontweight = 'bold')
    ...
    savepath = "C:/Users/laure/OneDrive/Desktop/YoRiS desktop/YoRiS/plots/BB fits/Diego_presentation_BB_plot.png"
