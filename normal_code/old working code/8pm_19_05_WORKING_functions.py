    ...
    def plot_individual_BB_fits(self, band_colour_dict, band_marker_dict):
        ...
        if self.indiv_plot_MJDs is not None:
            ...
            for i, MJD in enumerate(self.indiv_plot_MJDs):
                ...
                title3 = self.format_sci_with_uncertainty(value = self.BB_fit_results.loc[MJD, 'brute_R_cm'], upper = self.BB_fit_results.loc[MJD, 'brute_R_err_upper_cm'], lower = self.BB_fit_results.loc[MJD, 'brute_R_err_lower_cm']) + ' cm'
                title2 = self.format_sci_with_uncertainty(value = self.BB_fit_results.loc[MJD, 'brute_T_K'], upper = self.BB_fit_results.loc[MJD, 'brute_T_err_upper_K'], lower = self.BB_fit_results.loc[MJD, 'brute_T_err_lower_K']) + ' K\n'
                ...
                leg = ax.legend(handles = [h_BB], labels = [title2 + title3], prop = {'weight': 'bold', 'size': '8'})#, loc='lower left', bbox_to_anchor=(0.05, 0.05))
    ...
    def plot_individual_double_BB_fits(self, band_colour_dict, band_marker_dict): 
        ...
        if self.indiv_plot_MJDs is not None:
            ...
            for i, MJD in enumerate(self.indiv_plot_MJDs):
                ...
                title2 = self.format_sci_with_uncertainty_symmetric(value = self.BB_fit_results.loc[MJD, 'cf_T1_K'], error = self.BB_fit_results.loc[MJD, 'cf_T1_err_K']) + ' K'
                #title3 = r'R1 = '+f"{self.BB_fit_results.loc[MJD, 'cf_R1_cm']:.1e} +/- {self.BB_fit_results.loc[MJD, 'cf_R1_err_cm']:.1e} cm"
                title3 = self.format_sci_with_uncertainty_symmetric(value = self.BB_fit_results.loc[MJD, 'cf_R1_cm'], error = self.BB_fit_results.loc[MJD, 'cf_R1_err_cm']) + ' cm'
                #title4 = r'T2 = '+f"{self.BB_fit_results.loc[MJD, 'cf_T2_K']:.1e} +/- {self.BB_fit_results.loc[MJD, 'cf_T2_err_K']:.1e} K"
                title4 = self.format_sci_with_uncertainty_symmetric(value = self.BB_fit_results.loc[MJD, 'cf_T2_K'], error = self.BB_fit_results.loc[MJD, 'cf_T2_err_K']) + ' K'
                #title5 = r'R1 = '+f"{self.BB_fit_results.loc[MJD, 'cf_R2_cm']:.1e} +/- {self.BB_fit_results.loc[MJD, 'cf_R2_err_cm']:.1e} cm"
                title5 = self.format_sci_with_uncertainty_symmetric(value = self.BB_fit_results.loc[MJD, 'cf_R2_cm'], error = self.BB_fit_results.loc[MJD, 'cf_R2_err_cm']) + ' cm'
                ...
                ax.set_title(subplot_title, fontsize = 9.5, fontweight = 'bold')
                leg = ax.legend(handles = [h1, h2], labels = [title2 + '\n'+ title3, title4 + '\n'+ title5], fontsize = 7.5, prop = {'weight': 'bold', 'size': 7.5})
                leg.get_frame().set_alpha(0.6)
    ...
    def plot_individual_power_law_SED_fits(self, band_colour_dict, band_marker_dict):
        ...
        if self.indiv_plot_MJDs is not None:
            ...
            for i, MJD in enumerate(self.indiv_plot_MJDs):
                ...
                title2 = self.format_sci_with_uncertainty(value = self.BB_fit_results.loc[MJD, 'brute_A'], upper = self.BB_fit_results.loc[MJD, 'brute_A_err_upper'], lower = self.BB_fit_results.loc[MJD, 'brute_A_err_lower']) + '\n'
                ...
                #title3 = self.format_sci_with_uncertainty_symmetric(value = self.BB_fit_results.loc[MJD, 'brute_gamma'])
                ...
                leg = ax.legend(handles = [h_BB], labels = [title2 + title3], prop = {'weight': 'bold', 'size': '8'})
                leg.get_frame().set_alpha(0.6)
                ax.set_title(subplot_title, fontsize = 9.5, fontweight = 'bold')
