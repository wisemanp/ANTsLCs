...
fig, axs = plt.subplots(6, 3, figsize = (8.2, 11.6))
...
plt.suptitle('Light curves of all ANTs used in this study', fontsize=11, fontweight='bold', va = 'center', y = 0.98)
fig.supxlabel('MJD', fontweight = 'bold', va = 'center', y = 0.17)
fig.supylabel('Apparent magnitude (PS1-10adi and PS1-13jw are in absolute magnitude)', fontweight = 'bold', va = 'center', x = 0.01)
plt.subplots_adjust(top=0.937,
    ...
    hspace=0.39,
    wspace=0.161)
savepath = "C:/Users/laure/OneDrive/Desktop/YoRiS desktop/YoRiS/plots/light curves/MTR_split_ALL_ANT_lc.png"
